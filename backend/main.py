...
async def djapollo_terms():
    html = (
        "<!DOCTYPE html><html><head><meta charset='UTF-8'><title>Terms of Service - DJ Apollo</title>"
        "<style>body{font-family:Arial,sans-serif;max-width:800px;margin:0 auto;padding:40px 20px;"
        "background:#0a0a0a;color:#ddd;line-height:1.7}h1{color:#00E5FF}h2{color:#fff}a{color:#00E5FF}p{color:#bbb}</style></head>"
        "<body><h1>DJ Apollo - Terms of Service</h1><p>Last updated: March 22, 2026</p>"
...
async def djapollo_privacy():
    html = (
        "<!DOCTYPE html><html><head><meta charset='UTF-8'><title>Privacy Policy - DJ Apollo</title>"
        "<style>body{font-family:Arial,sans-serif;max-width:800px;margin:0 auto;padding:40px 20px;"
        "background:#0a0a0a;color:#ddd;line-height:1.7}h1{color:#00E5FF}h2{color:#fff}a{color:#00E5FF}p{color:#bbb}</style></head>"
        "<body><h1>DJ Apollo - Privacy Policy</h1><p>Last updated: March 22, 2026</p>"
        "<h2>1. Introduction</h2><p>Techtonomy, LLC operates DJ Apollo and is committed to protecting your privacy.</p>"
        "<h2>2. Data Collection</h2><p>We do not directly collect personal data. Third-party platforms collect data per their own policies.</p>"
